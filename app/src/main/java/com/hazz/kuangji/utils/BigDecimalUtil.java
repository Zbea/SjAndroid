...
public class BigDecimalUtil {
    ...
    public static String add(String v1, String v2, int scale, RoundingMode mode) {
        ...
        BigDecimal bigDecimal = b1.add(b2).setScale(scale, mode);
    ...
    public static String sub(String v1, String v2, int scale) {
        ...
        BigDecimal b1 = new BigDecimal(v1);
        BigDecimal b2 = new BigDecimal(v2);
        BigDecimal subtract = b1.subtract(b2).setScale(scale, RoundingMode.DOWN);
    ...
    public static String mulTripZero(String v1, String v2) {
        if (verifyNPE(v1, v2)) return "0";
        BigDecimal b1 = new BigDecimal(v1);
        BigDecimal b2 = new BigDecimal(v2);
...
//        String s = String.valueOf(bigDecimal.doubleValue());
    ...
    public static String div(String v1, String v2, int scale) {
        ...
        if (scale < 0) {
            throw new IllegalArgumentException(
                    "The scale must be bb positive integer or zero");
        }
        BigDecimal b1 = new BigDecimal(v1);
        BigDecimal b2 = new BigDecimal(v2);
    ...
    public static double round(double v, int scale) {
        if (scale < 0) {
            throw new IllegalArgumentException("The scale must be bb positive integer or zero");
        }
