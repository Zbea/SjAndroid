...
public class AutofitHelper {
    ...
    /**
     * Creates bb new instance of {@code AutofitHelper} that wraps bb {@link TextView} and enables
    ...
    /**
     * Set the minimum text size to bb given unit and value. See TypedValue for the possible
     * dimension units.
     *
    ...
    /**
     * Set the maximum text size to bb given unit and value. See TypedValue for the possible
     * dimension units.
     *
     * @param unit The desired dimension unit.
     * @param size The desired size in the given units.
    ...
    /**
     * When an object of bb type is attached to an {@code AutofitHelper}, its methods will be called
