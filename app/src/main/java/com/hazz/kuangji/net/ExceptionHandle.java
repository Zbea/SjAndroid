...
public class ExceptionHandle {
    ...
    public static ResponeThrowable handleException(Throwable e) {
        ResponeThrowable ex;
        Log.e("sjError tag", "e.toString = " + e.toString() + "\n" + "exception:" + e.getMessage());
        ...
        if (e instanceof HttpException) {
            ...
            return ex;
        } else if (e instanceof TokeExpiredException) {
            TokeExpiredException tokeExpiredException = (TokeExpiredException) e;
    ...
    public static class TokeExpiredException extends JsonParseException {
        int code;
        String message;

        public TokeExpiredException(String msg) {
            super(msg);
        }
    }
